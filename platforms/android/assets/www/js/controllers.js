...
.controller('EditProfileCtrl', function($scope, $http, $location, $ionicHistory, $document, $ionicGesture, $state, $base64) {
  ...
  $scope.editProfile = function () {
    ...
    $http({
      method: 'PUT',
      url: 'http://localhost:8080/user/' + $scope.$userData.username + '/',
...
.controller('EventListCtrl', function($scope, $http, $timeout) {
  ...
  $http({
    method: 'GET',
    url: 'http://localhost:8080/cart/products/?type=evnt',
  }).then(function successCallback(response){
    console.log(response.data);
  ...
  $scope.search = function() {
    ...
    let promise = $timeout(()=>{
      $http({
        method: 'GET',
        url: 'http://localhost:8080/cart/products/?type=evnt&q='+$scope.str.query,
      }).then(function successCallback(response) {
        $scope.insearch = false;
        console.log(response.data);
        $scope.events = response.data;
...
.controller('ClubListCtrl', function($scope, $http) {
  ...
  $http({
    method: 'GET',
    url: 'http://localhost:8080/clubs/?q=',
  }).then(function successCallback(response){
    console.log(response.data);
  ...
  $scope.search = function() {
    ...
    $http({
      method: 'GET',
      url: 'http://localhost:8080/clubs/?q='+$scope.str.query,
    }).then(function successCallback(response) {
      $scope.insearch = false;
      console.log(response.data);
      $scope.clubs = response.data;
...
.controller('ClubDetailCtrl', function(
  ...
  $http({
    method: 'GET',
    url: 'http://localhost:8080/club/'+$stateParams.id,
  }).then(function successCallback(response){
    $scope.hide();
    console.log(response.data);
...
.controller('EventDetailCtrl', function(
  ...
  $http({
    method: 'GET',
    url: 'http://localhost:8080/cart/product/'+$stateParams.id,
  }).then(function successCallback(response){
    $scope.hide();
    console.log(response.data);
...
.controller('FindClubsDetailCtrl', function($scope, $cordovaGeolocation, $http, $ionicLoading) {
  ...
  $scope.getclubs = function(lt, lg) {
    $http({
      method: 'GET',
      url: 'http://localhost:8080/searchnearclubs/?lat='+ lt +'&lon=' + lg,
    }).then(function successCallback(response) {
      $scope.hide();
      console.log(response);
      $scope.clubs = response.data;
