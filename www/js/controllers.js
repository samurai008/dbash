...
.controller('EventListCtrl', function($scope, $http, $timeout) {
  ...
  $http({
    method: 'GET',
    url: 'http://localhost:8000/cart/products/?type=evnt',
  }).then(function successCallback(response){
    console.log(response.data);
  ...
  $scope.search = function() {
    ...
    let promise = $timeout(()=>{
      $http({
        method: 'GET',
        url: 'http://localhost:8000/cart/products/?type=evnt&q='+$scope.str.query,
      }).then(function successCallback(response) {
        $scope.insearch = false;
        console.log(response.data);
        $scope.events = response.data;
...
.controller('EventDetailCtrl', function(
  ...
  $http({
    method: 'GET',
    url: 'http://localhost:8000/cart/product/'+$stateParams.id,
  }).then(function successCallback(response){
    $scope.hide();
    console.log(response.data);
...
.controller('FlatCtrl', function($scope, $state){
  console.log("obj");
})
